...
public class AtlasManager : ILoadable
{
    ...
    public static AtlasTexture GetTexture(string textureName)
    {
        ...
        ModContent.GetInstance<Stella>().Logger.Error($"Atlas texture with name {textureName} was not found!");
        return null;
    }
    ...
    public static Atlas GetAtlas(string atlasName)
    {
        ...
        ModContent.GetInstance<Stella>().Logger.Info($"Atlas '{atlasName}' is not registered!");
        return null;
    }
