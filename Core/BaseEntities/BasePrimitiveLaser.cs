...
using Stella.Assets;
using Stella.Core.Graphics.Primitives;
...
public abstract class BasePrimitiveLaser : ModProjectile
{
    ...
    public override string Texture => AssetDirectories.InvisiblePixelPath;
